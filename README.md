...
- go.sh скрипт сделать так чтобы не зависил от путей и анализирова лог файл который создает конфигурацонный скрипт
- проверить еще раз все скрипты на зависимости от путей и логичность путей
- продумать всё таки надобность указания в мейкфайле имен и нужна ли эта привязка вообще "защита от дурака"
